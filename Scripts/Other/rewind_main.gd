...
var replacements = {
	...
	"most_listened_to_day_name" : ScrobbleAnalyzer.most_listened_to_day_name,
	"most_listened_to_day_count" : ScrobbleAnalyzer.most_listened_to_day_count,
	"most_listened_to_month_name" : ScrobbleAnalyzer.most_listened_to_month_name,
